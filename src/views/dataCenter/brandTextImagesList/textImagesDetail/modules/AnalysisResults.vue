...
import MoodAnalysisAndContentSummarize from '@/views/dataCenter/brandVideoList/videoDetail/modules/MoodAnalysisAndContentSummarize.vue'
...
<template>
  <div class="mx-1 mb-2 flex flex-col gap-4">
