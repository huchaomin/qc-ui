...
export const createApis = (alovaInstance: Alova<AlovaGenerics>, configMap: any) => {
  const Apis = new Proxy({} as PlAdmin, {
    get(_, property) {
...
type MethodConfig<T> = AlovaMethodCreateConfig<
  ...
  T
>;
type APISofParameters<Tag extends string, Url extends string> = Tag extends keyof PlAdmin
  ? Url extends keyof PlAdmin[Tag]
    ? PlAdmin[Tag][Url] extends (...args: any) => any
      ? Parameters<PlAdmin[Tag][Url]>
      : any
    : any
  : any;
